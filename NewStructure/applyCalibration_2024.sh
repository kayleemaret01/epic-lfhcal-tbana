...
# 	Calib $3 $calibFile1 $dataDirIn $dataDirOut muonScanA1_45V ../PlotsMuonCalibrated_2024/Run_
# 	Calib $3 $calibFile2 $dataDirIn $dataDirOut muonScanA2_45V ../PlotsMuonCalibrated_2024/Run_
	
# 	electron runs
	runs='251 252 254 257 258 ' 
# 	runs=' 251 ' 
	for runNr in $runs; do 
		Calib $3 $calibFile1 $dataDirInE $dataDirOutE $runNr ../PlotsElectronCalibrated_2024/Run_
	done;
	
# 	#hadron runs
# 	runs='261 264 265 269 270 272 274 275 ' 
# 	for runNr in $runs; do 
# 		Calib $3 $calibFile1 $dataDirInH $dataDirOutH $runNr ../PlotsHadronCalibrated_2024/Run_
# 	done;
elif [ $2 == "ScanB" ]; then
	...
	pedScanB2_42V='369'
# 	Calib $3 $calibFile1 $dataDirIn $dataDirOut muonScanB1_42V ../PlotsMuonCalibrated_2024/Run_
	Calib $3 $calibFile2 $dataDirIn $dataDirOut muonScanB2_42V ../PlotsMuonCalibrated_2024/Run_
...
# 	pedScanC2_43V='404'
	Calib $3 $calibFile1 $dataDirIn $dataDirOut muonScanC1_43_5V ../PlotsMuonCalibrated_2024/Run_
	Calib $3 $calibFile2 $dataDirIn $dataDirOut muonScanC2_43_5V ../PlotsMuonCalibrated_2024/Run_
# 	
# # 	#electron runs
...
# 	calibFile1=$dataDirCal/CalibFinal_muonScanB1_42V.root 
	...
	pedScanD2_45V='454'
	Calib $3 $calibFile2 $dataDirIn $dataDirOut muonScanD2_45V ../PlotsMuonCalibrated_2024/Run_
	
# 	electron runs
	runs='421 422 429 430 432 ' 
	for runNr in $runs; do 
		Calib $3 $calibFile2 $dataDirInE $dataDirOutE $runNr ../PlotsElectronCalibrated_2024/Run_
	done;
...
# 	runs='441 444 445 449 452 ' 
	for runNr in $runs; do 
		Calib $3 $calibFile2 $dataDirInH $dataDirOutH $runNr ../PlotsHadronCalibrated_2024/Run_
	done;
fi
